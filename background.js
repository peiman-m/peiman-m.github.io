...
(function () {
  ...
  var PATHS       = 1;
  var GRID        = 88;    // prediction points along the path
  var STEP_FRAMES = 320;   // frames between observations, roughly five seconds
  var EASE_FRAMES = 250;   // frames to ease from one posterior to the next, about four
  ...
  var SMOOTH_PASSES = 4;   // low-pass along the path, to kill grid-scale roughness
